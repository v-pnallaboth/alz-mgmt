metadata name = 'ALZ Bicep - Landing Zones-Local Module'
metadata description = 'ALZ Bicep Module used to deploy the Landing Zones-Local Management Group and associated resources such as policy definitions, policy set definitions (initiatives), custom RBAC roles, policy assignments, and policy exemptions.'
...
@description('Required. The management group configuration for Landing Zones-Local.')
param landingZonesLocalConfig alzCoreType
...
var managementGroupFinalName = landingZonesLocalConfig.?managementGroupName ?? 'local'
var intRootManagementGroupFinalName = landingZonesLocalConfig.?managementGroupIntermediateRootName ?? 'alz'
...
var unionedRbacRoleDefs = union(alzRbacRoleDefsJson, landingZonesLocalConfig.?customerRbacRoleDefs ?? [])

var unionedPolicyDefs = union(alzPolicyDefsJson, landingZonesLocalConfig.?customerPolicyDefs ?? [])

var unionedPolicySetDefs = union(alzPolicySetDefsJson, landingZonesLocalConfig.?customerPolicySetDefs ?? [])

var unionedPolicyAssignments = union(
  alzPolicyAssignmentsWithOverrides,
  landingZonesLocalConfig.?customerPolicyAssignments ?? []
)
...
module landingZonesLocal 'br/public:avm/ptn/alz/empty:0.3.6' = {
  params: {
    createOrUpdateManagementGroup: landingZonesLocalConfig.?createOrUpdateManagementGroup
    managementGroupName: managementGroupFinalName
    managementGroupDisplayName: landingZonesLocalConfig.?managementGroupDisplayName ?? 'Local'
    managementGroupDoNotEnforcePolicyAssignments: landingZonesLocalConfig.?managementGroupDoNotEnforcePolicyAssignments
    managementGroupExcludedPolicyAssignments: landingZonesLocalConfig.?managementGroupExcludedPolicyAssignments
    managementGroupParentId: landingZonesLocalConfig.?managementGroupParentId ?? 'landingzones'
    managementGroupCustomRoleDefinitions: allRbacRoleDefs
    managementGroupRoleAssignments: landingZonesLocalConfig.?customerRbacRoleAssignments
    ...
    location: parLocations[0]
    subscriptionsToPlaceInManagementGroup: landingZonesLocalConfig.?subscriptionsToPlaceInManagementGroup
    waitForConsistencyCounterBeforeCustomPolicyDefinitions: landingZonesLocalConfig.?waitForConsistencyCounterBeforeCustomPolicyDefinitions
    waitForConsistencyCounterBeforeCustomPolicySetDefinitions: landingZonesLocalConfig.?waitForConsistencyCounterBeforeCustomPolicySetDefinitions
    waitForConsistencyCounterBeforeCustomRoleDefinitions: landingZonesLocalConfig.?waitForConsistencyCounterBeforeCustomRoleDefinitions
    waitForConsistencyCounterBeforePolicyAssignments: landingZonesLocalConfig.?waitForConsistencyCounterBeforePolicyAssignments
    waitForConsistencyCounterBeforeRoleAssignments: landingZonesLocalConfig.?waitForConsistencyCounterBeforeRoleAssignments
    waitForConsistencyCounterBeforeSubPlacement: landingZonesLocalConfig.?waitForConsistencyCounterBeforeSubPlacement
